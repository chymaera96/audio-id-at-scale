...
python benchmark.py --fp_dir=/data/scratch/acw723/logs/emb/large/model_nmfp --dummy_dir=/data/scratch/acw723/synth/nmfp0_epoch97_100M  --test_ids=500 --num_dummy=10000 --iterations=1 --mean=-0.000410  --std=0.088388